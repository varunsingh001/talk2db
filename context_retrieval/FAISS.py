...
class FAISS(ContextStore):
    def __init__(self, config={}, embeddings_model=None):
        ContextStore.__init__(config)        
        self.path = config.get("path_to_context_store", ".")
    ...
    def generate_embedding(self, data: str, **kwargs) -> List[float]:
        embedding = self.embedding_model.get_embedding(data)
